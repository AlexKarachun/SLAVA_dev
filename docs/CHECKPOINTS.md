...
Итого 536 эпизодов собрано, **500 идут в метрики**: 36 эпизодов `ru_case_swap` помечены устаревшими 07.08.2026 после смены критерия успеха для этого варианта (`data/rollout_provenance.json`). Эпизоды
