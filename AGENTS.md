...
**D5 закрыт по сбору: 536 эпизодов, покрытие полное.** В метриках 500 из них — 36 `ru_case_swap` помечены устаревшими после смены критерия успеха (07.08.2026, см. ниже).
