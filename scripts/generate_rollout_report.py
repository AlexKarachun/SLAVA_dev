...
<section>
  ...
  <table class="data-table"><thead><tr>
    <th>Что проверялось</th><th>Было до исправлений</th><th>Стало</th>
  </tr></thead><tbody>
    <tr><td>Факт успеха (получилось / не получилось)</td><td>97 / 100 = 97%</td><td><b>99 / 100 = 99%</b></td></tr>
    <tr><td>Тип ошибки (какая именно из восьми меток)</td><td>76 / 100 = 76%</td><td><b>80 / 100 = 80%</b></td></tr>
  </tbody></table>
