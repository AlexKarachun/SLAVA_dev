...
**Если кэша нет вообще** — статуслайн в этом фронтенде может не запускаться
(например, в VS Code-расширении это фича терминального UI). Тогда процентов
лимита взять неоткуда, но расход и размер контекста всё равно видны из
транскрипта сессии:
